-- AlterTable
ALTER TABLE "Submission" ADD COLUMN "termsAcceptedAt" DATETIME;
...
INSERT INTO "new_CollabRequest" ("aspectRatio", "assetType", "authorId", "backgroundPath", "colorPalette", "createdAt", "description", "format", "id", "imageCount", "maxFileSizeMB", "outputFileName", "resolution", "status", "styleNotes", "tierMax", "tierMin", "title") SELECT "aspectRatio", "assetType", "authorId", "backgroundPath", "colorPalette", "createdAt", "description", "format", "id", "imageCount", "maxFileSizeMB", "outputFileName", "resolution", "status", "styleNotes", "tierMax", "tierMin", "title" FROM "CollabRequest";
